                ...
                child: Container(
                    ...
                    child: Column(children: [
                      ...
                      FutureBuilder<bool>(
                        ...
                        builder: (context, filenameNotEmpty) => Text(
                            filenameNotEmpty.data ?? true ? "" : "filename can't be empty",
                            style: _textThemeError),
                      ),
                      FutureBuilder<bool>(
                        future: vm.isPasswordsNotEmpty(),
                        builder: (context, passwordsNotEmpty) => Text(
                            passwordsNotEmpty.data ?? true ? "" : "passwords can't be empty",
                            style: _textThemeError),
                      ),
                      const SizedBox(height: 12.0),
                      FutureBuilder<bool>(

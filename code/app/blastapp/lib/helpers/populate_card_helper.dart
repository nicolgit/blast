                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: isPassword
                            ? IconButton(
                                onPressed: () {
                                  setState(() => hideValue = !hideValue);
                                },
                                icon: Icon(hideValue ? Icons.visibility : Icons.visibility_off),
                                tooltip: hideValue ? 'Show password' : 'Hide password',
                              )
                            : null,
                      ),
                    ),
